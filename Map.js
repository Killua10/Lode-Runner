var tabMap = [['F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F'],
    ...
    ['F', 'F', 'F', 'F', 'F', 'F', 'F', 'E', 'C', 'C', 'C', 'C', 'C', 'C', 'F', 'C', 'C', 'C', 'F', 'F', 'F', 'F', 'F', 'O', 'F', 'F', 'F', 'F'],
    ...
    for (var row = 0; row < tabMap.length; row++) {
        for (var col = 0; col < tabMap[row].length; col++) {
            ...
            switch (tabMap[row][col]) {
                case 'F':
                    objC2D.drawImage(objImageFond, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "FOND";
                ...
                case 'C':
                    objC2D.drawImage(objImageCorde, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "CORDE";
                ...
                case 'M':
                    objC2D.drawImage(objImageMur, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "MUR";
                ...
                case 'O':
                    objC2D.drawImage(objImageOr, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "OR";
                    objet.objImage = objImageFond;
                    objet.intLongeur = 40;
                    objet.intLargeur = 40;
                ...
                case 'B':
                    objC2D.drawImage(objImageBase, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "BASE";
                ...
                case 'T':
                    objC2D.drawImage(objImageTrou, intTuileX, intTuileY, 40, 40);
                    objet.objNom = "TROU";
...
function genereNewMap() {
    tabMap = [['F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F'],
        ['F', 'F', 'F', 'F', 'O', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F'],
        ['M', 'M', 'M', 'M', 'M', 'M', 'M', 'E', 'M', 'M', 'M', 'M', 'M', 'M', 'M', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F'],
        ['F', 'F', 'F', 'F', 'F', 'F', 'F', 'E', 'C', 'C', 'C', 'C', 'C', 'C', 'F', 'C', 'C', 'C', 'F', 'F', 'F', 'F', 'F', 'O', 'F', 'F', 'F', 'F'],
        ['F', 'F', 'F', 'F', 'F', 'F', 'F', 'E', 'F', 'F', 'F', 'F', 'M', 'M', 'E', 'F', 'F', 'F', 'M', 'M', 'M', 'M', 'M', 'M', 'M', 'E', 'M', 'M'],
